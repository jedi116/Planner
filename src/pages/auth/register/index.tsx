...
import { BoxesLoaderComponent } from '@components/common/boxeLoader'
      ...
      {loading ? (
        ...
        <div className='register'>
          <form className='form' onSubmit={register}>
            {!formValidation.fullNameValid && (
              <Alert severity='error'>{formValidation.fullNameErrorMessage}</Alert>
            )}
            <input
              type='text'
