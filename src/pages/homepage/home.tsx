...
export const Home: React.FC<Record<string, never>> = () => {
  return (
    <div>
      <div
        className='container-fluid position-relative overflow-hidden mb-4 mb-sm-0'
        style={{ minBlockSize: '95vh' }}
      >
          ...
          <div className='row pt-xl-5 pt-lg-5 d-sm-flex flex-column-reverse flex-lg-row text-center text-md-start'>
            <div className='col-xl-6 col-lg-7 pt-xl-5 mt-xl-5 mt-lg-5'>
              ...
              <h1 className='h1 fw-bold'>
                Plan for the
                <span className='d-block d-sm-inline gunmetal px-2 text-white rounded'>Future</span>
                easily
              </h1>
            ...
            <div className='col-xl-6 col-lg-5 mt-lg-5 position-relative'>
              <img src={workImage} alt='' className='img-fluid scale-up' />
            </div>
          </div>
        </div>
      </div>
